...
Fraunces/Inter pairing, "intake checklist" rail). CSS/markup only — no
...
.day-toggle/etc.) should ever be renamed or removed here; only styling.
"""
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  a.btn-secondary { display: inline-block; text-decoration: none; font-weight: 500; font-size: 14px; padding: 11px 22px; border-radius: 8px; }
  ...
  .warning-banner {
    background: var(--clay-tint); border: 1px solid #E3B79A; color: #7A3D1F;
  ...
  .list-row-title { font-weight: 600; font-size: 14.5px; color: var(--ink); }
  ...
  .pill {
    display: inline-block; font-size: 11px; font-weight: 600; padding: 3px 10px; border-radius: 100px;
  ...
  .stat-tile .stat-value { font-family: var(--font-display); font-size: 26px; color: var(--sage-deep); }
