...
export default function PatientDetailPage() {
  ...
  const columns = createVisitHistoryColumns({
    followupPanelId,
    onOpenFollowup: openFollowupPanel,
    onCloseFollowup: closeFollowupPanel,
    expandedVisit,
    setExpandedVisit,
    notesByVisit,
  });
    ...
    <PortalShell hospital={hospital} active="patients">
      ...
      <div className="grid grid-cols-1 gap-space-4 lg:grid-cols-[1fr_320px]">
          ...
          <Card className="p-space-4">
            ...
            <div className="flex items-end gap-space-2">
              ...
              <Button
                ...
                disabled={savingGeneralNote || !generalNoteDraft.trim()}
              >
        ...
        {/* One wrapping div (not 3 separate grid children) so these stack
              vertically in the sidebar column -- 3+ un-wrapped children in
