  ...
  return (
    <div>
      ...
      <div className="mb-space-4 gap-space-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="gap-space-4 border-line bg-paper p-space-4 flex rounded-lg border">
          ...
          <ol className="space-y-space-2 pl-space-4 text-ink-600 marker:text-brand-600 list-decimal text-[14px] leading-relaxed marker:font-semibold">
            ...
            <li>
              Give it a name (e.g. &quot;[Hospital Name] Bot&quot;) and set its role to{" "}
              <strong>Admin</strong>.
            </li>
            <li>
              Click <strong>Assign Assets</strong> → <strong>Apps</strong> tab → select the app you
              created in Step 2 → give it <strong>Full Control</strong>.
            </li>
            <li>
              Click <strong>Generate New Token</strong> → select that same app → under permissions,
              check <strong>whatsapp_business_messaging</strong> and{" "}
              <strong>whatsapp_business_management</strong> → set expiration to{" "}
              <strong>Never</strong> → <strong>Generate Token</strong>.
            </li>
            <li>
              <strong>Copy the token immediately and paste it below</strong> — Meta only shows it
              once; if you lose it, you&apos;ll need to generate a new one.
            </li>
          </ol>
        </div>
      ...
      <Field
        ...
        hint="You'll find this on the System User's &quot;Generate token&quot; screen."
      >
        <Input
          id="access_token"
