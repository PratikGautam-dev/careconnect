...
export function DoctorLeaveManager({ doctorId }: { doctorId: string }) {
  ...
  return (
    <div className="border-line bg-paper p-space-3 rounded-lg border">
      <p className="text-label mb-space-2 text-ink-900 font-semibold">Leave dates</p>
      {leave === null ? (
      ...
      <div className="gap-space-2 flex flex-wrap items-end">
        <div>
          <label className="mb-space-1 text-ink-400 block text-[11px] font-semibold">From</label>
          <Input
            type="date"
            value={fromDate}
            onChange={(e) => {
        ...
        <div>
          <label className="mb-space-1 text-ink-400 block text-[11px] font-semibold">To</label>
          <Input
            type="date"
            value={toDate}
