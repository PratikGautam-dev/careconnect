...
// Add doctor/Create test navigate to the existing management pages, which
// already own their add-forms (Create test = define a new bookable test
// TYPE, in Settings -- different from Book test below, which books an
// appointment against an EXISTING test). Add staff/Book appointment/Book
// test open the same AddStaffDialog/NewBookingDialog/NewTestBookingDialog
// the Staff page's/Doctor appointments'/Diagnostic & lab pages' own "Add
// Staff"/"Add new appointment"/"New test booking" quick actions do, rather
// than just linking there. Export has no backend anywhere in this app --
// disabled, same "Coming soon" convention PortalSidebar uses for its own
// unbuilt nav items.
